...
AP.sigma   = 0.5;         % low-pass filter cutoff for derivative terms
...
zeta_roll    = 0.800;
omega_n_roll = 0.05;          % rad/s — choose fast enough (< actuator BW)
...
%   → kp = (2ζω_n - a_V1) / a_V2
%   → ki = ω_n^2 / a_V2
zeta_Va_throttle    = 0.800;
omega_n_Va_throttle = 0.01;    % rad/s
...
%   → ki = ω_n^2 / (-a_V3)
zeta_Va_pitch    = 0.800;
omega_n_Va_pitch = 0.005;       % rad/s — must be slower than pitch loop
