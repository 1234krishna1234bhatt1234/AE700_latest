...
% a_theta3 =  (ρ·Va²·S·c)/(2·Jy) · C_m_delta_e   [elevator effectiveness, <0 since C_m_δe<0]
...
% ---- AIRSPEED subsystem (B&M Eq. 5.13–5.15 Modified for Jet) ----
...
%   Thrust = delta_t * T_max
%   → ∂T/∂Va      = 0 (Jet thrust does not degrade with airspeed)
%   → ∂T/∂delta_t = T_max
%
...
a_V1 = (P.rho * Va_trim * P.S_wing / P.mass) * C_D_trim;
a_V2 = P.T_max / P.mass;
