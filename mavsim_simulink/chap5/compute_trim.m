...
MAV.q0     = x_trim(11);
MAV.r0     = x_trim(12);
alpha_deg = atan2(x_trim(6), x_trim(4)) * 180/pi;
gamma_check = x_trim(8) - alpha_deg*(pi/180);
...
fprintf('--- Validation ---\n');
fprintf('Calculated Alpha: %.2f deg \n', alpha_deg);
fprintf('Climb Rate (h_dot): %.2f m/s\n', -dx_trim(3));
fprintf('Theoretical Climb:  %.2f m/s\n', Va * sin(gamma));
display(x_trim');display(x0'); display(y_trim');display(y0');
